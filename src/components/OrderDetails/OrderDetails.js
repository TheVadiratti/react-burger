...
function OrderDetails() {
  return (
    <>
      <span className='text text_type_digits-large'>{Math.floor(Math.random( ) * (999999 + 1))}</span>
      <span className='text text_type_main-medium mb-8'>идентификатор заказа</span>
